...
export function careersFromBrandingJson(
  brandingJson: Record<string, unknown> | null | undefined,
): CareersConfig {
  const careers = brandingJson?.careers as Partial<CareersConfig> | undefined;
  return mergeCareersConfig(careers);
}
